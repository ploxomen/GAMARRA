...
class RapiFac extends Controller
{
    ...
    return [
        ...
        "Bultos" => 2,
        "BultosCelular" => 2,
        "ClienteDireccion" => "CAL. HIPOLITO UNANUE MZ. B LT. 1 URB. LAS MALVINAS - CUSCO - CUSCO - SANTIAGO",
        "ClienteNombreRazonSocial" => "RAPIFAC SOCIEDAD ANONIMA - RAPIFAC S.A.",
        "ClienteNumeroDocIdentidad" => "20600598334",
        "ClientePaisDocEmisor" => "PE",
        "ClienteTelefono" => "900900662",
        "ClienteTipoDocIdentidadCodigo" => "6",
        "ClienteTipoSunat" => 1,
        "ClienteUbigeo" => "080106",
        "ConductorLicencia" => "12365488",
        "ConductorLicencia2" => "",
        "ConductorNumeroDocIdentidad" => "",
        "ConductorTipoDocIdentidadCodigo" => "1",
        "Correlativo" => 144,
        "CorreoElectronicoPrincipal" => "quispehanccof1@gmail.com",
        "CreditoTotal" => 0,
        "DUADAMCodigo" => "",
        "DescuentoGlobalMonto" => 0,
        "DescuentoNGMonto" => 0,
        "DiasPermanencia" => 0,
        "DireccionLlegada" => "CAL. HIPOLITO UNANUE MZ. B LT. 1 URB. LAS MALVINAS - CUSCO - CUSCO - SANTIAGO",
        "DireccionPartida" => "Av. Arequipa N° 102 - Ate - Lima - Lima - ATE - LIMA - LIMA",
        "DocAdicionalCodigo" => 1,
        "DocAdicionalDetalle" => "",
        "ExoneradaXML" => 0,
        "Exportacion" => 0,
        "ExportacionXML" => 0,
        "FechaConsumo" => "19/09/2023",
        "FechaEmision" => "19/09/2023",
        "FechaIngresoEstablecimiento" => "19/09/2023",
        "FechaIngresoPais" => "19/09/2023",
        "FechaSalidaEstablecimiento" => "",
        "FechaTraslado" => "19/09/2023",
        "FormatoPDF" => 0,
        "GratuitoGravado" => 0,
        "Gravado" => 0,
        "GuiaNumero" => "",
        ...
        "ISCBase" => 0,
        "IdRepositorio" => 0,
        "ImporteTotalTexto" => "CERO CON 00/100 SOLES",
        "ImpuestoTotal" => 0,
        "ImpuestoVarios" => 0,
        "Inafecto" => 0,
        "InafectoXML" => 0,
        ...
        "ComprobanteID" => 0,
        "Control" => 0,
        "Descripcion" => "Detalle del item enviado",
        "Descuento" => 0,
        "DescuentoBase" => 0,
        "DescuentoCargo" => 0,
        "DescuentoCargoCodigo" => "00",
        ...
        "PrecioVenta" => 0,
        "PrecioVentaCodigo" => "01",
        "ProductoCodigo" => "1694627431",
        "ProductoCodigoCliente" => "1694627431",
        "ProductoCodigoSUNAT" => "56112005",
        "TipoAfectacionIGVCodigo" => "10",
        "TipoProductoCodigo" => "1",
        "TipoSistemaISCCodigo" => "00",
        ...
        "MotivoTrasladoCodigo" => "01",
        "MotivoTrasladoDescripcion" => "VENTA",
        "NOMBRE_UBIGEOLLEGADA" => "CUSCO - CUSCO - SANTIAGO",
        "NOMBRE_UBIGEOPARTIDA" => "LIMA - LIMA - ATE",
        "Observacion" => "",
        "PaisResidencia" => "AF",
        "PendientePago" => "0.00",
        "PercepcionFactor" => 0,
        ...
        "TotalPrecioVenta" => 0,
        "TotalValorVenta" => 0,
        "TransportistaNombreRazonSocial" => "C & T GROUP PERU SOCIEDAD ANONIMA CERRADA - C & T GROUP PERU S.A.C.",
        "TransportistaNombreRazonSocial2" => "",
        "TransportistaNumeroDocIdentidad" => "20602008194",
        "TransportistaNumeroDocIdentidad2" => "",
        "TransportistaTipoDocIdentidadCodigo" => "6",
        "TransportistaTipoDocIdentidadCodigo2" => "",
        "Ubigeo" => "150103",
        "UbigeoLlegada" => "080106",
        "UbigeoPartida" => "150103",
        "Usuario" => "13131313",
        "VehiculoAutorizacion" => "",
        "VehiculoAutorizacion2" => "",
        "VehiculoCertificado" => "",
        "VehiculoCertificado2" => "",
        "VehiculoConfiguracion" => "",
        "VehiculoConfiguracion2" => "",
        "VehiculoPlaca" => "sxc123",
        "VehiculoPlaca2" => "",
        "VehiculoRegistrado" => "",
        "Vendedor" => "",
        "VendedorNombre" => ""
