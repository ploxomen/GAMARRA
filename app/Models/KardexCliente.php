...
class KardexCliente extends Model
{
    ...
    static function kilajesRankingCliente($fechaIncio,$fechaFin) : Object {
    ...
    static function cantidadesRankingProveedor($fechaIncio,$fechaFin) : Object {
        return DB::table('kardex_fardos_detalle AS kfd')->select("p.nombre_proveedor","p.id")
        ...
        ->groupBy("kfd.id_proveedor")->orderBy("cantidades","desc")->get();
    }
    static function precioRankingAduanero($fechaIncio,$fechaFin) : Object {
        ...
        ->where('k.estado','>=',2)->where('a.estado','!=',0)->whereRaw("DATE_FORMAT(k.fechaCreada,'%Y-%m-%d') BETWEEN ? AND ?",[$fechaIncio,$fechaFin])->groupBy("a.id")->orderBy("costos","desc")
        ->get();
    }
}
