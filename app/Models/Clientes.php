...
class Clientes extends Model
{
    ...
    protected $fillable = ['nombreCliente','id_pais','tipo_documento','nro_documento','id_usuario','estado'];
    ...
    {
        $cliente = $query->select("clientes.id","usuarios.correo","clientes.id_pais AS paises","clientes.tipo_documento","clientes.nro_documento","clientes.nombreCliente","usuarios.celular","usuarios.telefono","usuarios.direccion","clientes.estado")
        ->join("usuarios","usuarios.id","=",'clientes.id_usuario')
        ->join("tipo_documento","clientes.tipo_documento","=","tipo_documento.id","left")
        ...
        if(!empty($cliente)){
            ...
            $cliente->tasas = DB::table('clientes_tasas')->select("id","id_categoria","tasa")->where('id_cliente',$cliente->id)->get();
        }
        return $cliente;
    }
