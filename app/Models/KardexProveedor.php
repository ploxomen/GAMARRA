...
class KardexProveedor extends Model
{
    ...
    protected $fillable = ['id_kardex','id_proveedores','id_cliente','observaciones','fechaRecepcion','estado'];
    const CREATED_AT = 'fechaCreada';
    const UPDATED_AT = 'fechaActualizada';

    public function scopeObtenerProveedoresKardexs($query){
        return $query->select("clientes.nombreCliente","proveedores.nombre_proveedor","kardex_proveedores.id_cliente AS idCliente","kardex_fardos.id_kardex AS idKardex","kardex_proveedores.id","kardex_proveedores.estado","kardex_proveedores.id_proveedores AS idProveedor")
