...
{
    public $table = "kardex";
    protected $fillable = ['nroFardoActivo','guia_aerea','id_aduanero','tasa_extranjera','cantidad','kilaje','importe','estado','guia_remision_sunat','factura_sunat','factura_total_sunat'];
    ...
    public static function scopeMisKardex($query) {
        return $query->select("kardex.id","kardex.guia_aerea","kardex.cantidad","kardex.tasa_extranjera","kardex.guia_remision_sunat","kardex.factura_sunat","kardex.kilaje","kardex.estado","kardex.id_aduanero","kardex.importe")
