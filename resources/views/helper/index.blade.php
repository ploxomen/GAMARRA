...
<body>
    ...
    <div class="contenedor">
        <div class="navegacion" id="menuNavegacion">
            <div class="mi-logo pt-5">
                <img src="/img/logo.png" alt="Imagen del logo">
                <h1 style="font-size: 1.5rem" class="text-white text-center pt-2">
                    {{auth()->user()->nombres}}
                </h1>
            </div>
            {{-- <div class="mi-perfil d-flex" style="gap: 10px;"> --}}
                @php
                    $usuario = auth()->user();
        ...
        <div class="panel">
            ...
            <div class="info-person">
                ...
                <div class="box-my">
                    ...
                    <div class="info-perfil">
                        <strong class="d-block">{{auth()->user()->roles()->where('activo',1)->first()->nombreRol}}</strong>
